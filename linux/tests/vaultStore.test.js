...
import { VaultStore, fingerprintFor, collapseText } from '../omelette@dfxe.github.io/vaultStore.js';
...
const dataDir = GLib.build_filenamev([GLib.get_user_data_dir(), 'omelette']);
